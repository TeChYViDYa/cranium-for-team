...
export default function Sidebar({ open, onClose }) {
  ...
  useEffect(() => {
    ...
    const sync = () => setIsDesktop(Boolean(mql.matches));
  ...
  return (
    ...
    <>
      ...
      <motion.aside
        ...
        className="fixed left-0 top-0 z-50 h-full w-72 border-r border-white/10 bg-midnight/75 backdrop-blur md:static md:block md:w-64"
      ...
      >
        ...
        <div className="flex h-14 items-center justify-between px-5 border-b border-white/10 md:hidden">
