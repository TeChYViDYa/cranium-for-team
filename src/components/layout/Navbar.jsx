    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 p-2 text-slate-100/90 transition hover:bg-white/10 focus:outline-none md:hidden"
